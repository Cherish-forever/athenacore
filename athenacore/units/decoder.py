...
class InstructionDecoder(wiring.Component):
    ...
    illegal:     Out(1)    # illegal instruction
    ...
    def elaborate(self, platform):
        ...
        m.d.comb += [
            ...
            jimm20.eq(Cat(0, insn[21:32], insn[20], insn[12:20], insn[31]))
        ]
        ...
        m.d.comb += [
            ...
            self.rs1_we.eq(reduce(or_, (fmt == T for T in (Type.R, Type.I, Type.S, Type.B)))),
            self.rs2_we.eq(reduce(or_, (fmt == T for T in (Type.R, Type.S, Type.B)))),
        ...
        m.d.comb += [
            ...
            self.adder_sub.eq(self.rs2_we & (funct7 == Funct7.SUB)),
        ...
        m.d.comb += [
            ...
            self.setx.eq(funct7 == Funct7.SRA),
            ...
            self.csr.eq(matcher([
                ...
                (Opcode.SYSTEM, Funct3.CSRRWI), # crsswi
